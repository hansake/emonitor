...
echo "</li>";
    ...
    $daycounters = cal_days_in_month(CAL_GREGORIAN, $nmonth, $nyear);
    ...
    $daydifftime = array_fill(0, $daycounters, 0);
    $daydiffcnt1 = array_fill(0, $daycounters, 0);
    $daydiffcnt2 = array_fill(0, $daycounters, 0);
    $daydiffcnt3 = array_fill(0, $daycounters, 0);
    $totcntr1 = 0.0;
    $totcntr2 = 0.0;
    $totcntr3 = 0.0;
    $totcntr4 = 0.0;
    ...
    for ($i = $daycounters; 0 <= $i; $i--)
    {
        ...
        {
            $wdaydiff1 = $wdaydifflast1 - $row[1];
            $wdaydifflast1 = $row[1];
            $wdaydiff2 = $wdaydifflast2 - $row[2];
            $wdaydifflast2 = $row[2];
            $wdaydiff3 = $wdaydifflast3 - $row[3];
            $wdaydifflast3 = $row[3];
            if ($i < $daycounters)
            {
                $daydifftime[$i] = $lasttimestamp;
                if ($wdaydiff1 < 0)
                    $wdaydiff1 = 0;
                $daydiffcnt1[$i] = $wdaydiff1;
                $totcntr1 += ($wdaydiff1 / 1000);
                if ($wdaydiff2 < 0)
                    $wdaydiff2 = 0;
                $daydiffcnt2[$i] = $wdaydiff2;
                $totcntr2 += ($wdaydiff2 / 1000);
                if ($wdaydiff3 < 0)
                    $wdaydiff3 = 0;
                $daydiffcnt3[$i] = $wdaydiff3;
                $totcntr3 += ($wdaydiff3 / 1000);
    ...
    $maxwatts1 = max($daydiffcnt1);
    $maxwatts2 = max($daydiffcnt2);
    $maxwatts3 = max($daydiffcnt3);
    ...
    $xticker = floor($graphwidth / count($daydiffcnt1));
