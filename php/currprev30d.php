...
tr:nth-child(even) {
 ...
 <head>
  <title>Current last 30 days</title>
 </head>
 <body>
...
<?php
    ...
    $hregisters = 30;
    $registertxt206 = "Current L1 in A"; /* Register 206 */
    $registertxt207 = "Current L2 in A"; /* Register 207 */
    $registertxt208 = "Current L3 in A"; /* Register 208 */
    ...
    $maxcurr = max($maxcurr206, $maxcurr207, $maxcurr208, ($currspacing * 2));
    ...
    for ($y = $botgraph; $y > $topgraph; $y -= $yspacing)
    {
        ...
        echo sprintf("%01.2f A", $currint / 100);
        echo '</text>';
        echo "\n   ";
